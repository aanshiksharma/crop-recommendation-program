        ...
        {result && (
          <div className="result-box success">
            ...
            <p className="result-item">
              {t("Crop")}:{" "}
              <span className="result-text">{t(result.recommended_crop)}</span>
            </p>
              ...
              (key) =>
                result[key] !== undefined && (
                  <p key={key} className="result-item">
                    {t(nutrientMap[key])}:{" "}
                    <span className="result-text">{result[key]}</span>
                  </p>
                )
            )}
            ...
            {result.risk_factors && (
              <p className="result-item">
                {t("RiskLevel")}:{" "}
                <span className="result-text">{t(result.risk_factors)}</span>
              </p>
            )}
            ...
            {result.annual_income && (
              <p className="result-item">
                {t("EstimatedIncome")}:{" "}
                <span className="result-text">{result.annual_income}</span>
              </p>
            )}
          </div>
        )}
